...
class DialogoManager:
	def __init__(self):
		...
		self.largura, self.altura = self.caixaTexto.get_size()
		self.caixaTexto.set_colorkey((100, 100, 100))
		self.seta = pg.transform.rotate(pg.image.load("recursos/sprites/batalha/index.png").convert(), -90)
		self.seta.set_colorkey((100, 100, 100))
...
#				self.emDialogo = False
	...
	def show(self, display):
		...
		display.blit(self.caixaTexto, (self.x, self.y))
		if self.mostrarSeta<14 and self.visivel[0]!=len(self.texto)-1 and (self.visivel[0]+1)%2==0 and self.visivel[1]==len(self.texto[self.visivel[0]])-1: 
			...
			display.blit(self.seta, (self.x+self.largura-24, self.y+self.altura-11))
...
#			display.blit(self.fonte.render(self.texto[0], 0, (0, 0, 0), (255, 255, 255)), (24, 110+16*i%2))
		if self.visivel[0]>0:
			display.blit(self.fonte.render(self.texto[self.visivel[0]-1], 0, (0, 0, 0), (255, 255, 255)), (self.x+24, self.y+6))
			display.blit(self.fonte.render(self.texto[self.visivel[0]][0:self.visivel[1]+1], 0, (0, 0, 0), (255, 255, 255)), (self.x+24, self.y+22))
		else:
			display.blit(self.fonte.render(self.texto[0][0:self.visivel[1]+1], 0, (0, 0, 0), (255, 255, 255)), (self.x+24, self.y+6))
		#if self.visivel[0]==1:
